...
let test_no_consts_no_funcs () =
  ...
  let q = Symb.add_anon_symb db 1 in
...
let test_consts_in_diff_sorts () =
  ...
  let q = Symb.add_anon_symb db 1 in
  let d = Symb.add_anon_symb db 0 in
  let e = Symb.add_anon_symb db 0 in
...
let test_distinct_consts_consts () =
  ...
  let db = prob.Prob.symbols in
  let p = Symb.add_anon_symb db 2 in
  let c1 = Symb.add_anon_symb db 0 in
  let q = Symb.add_anon_symb db 0 in
  let c2 = Symb.add_anon_symb db 0 in
  let c3 = Symb.add_anon_symb db 0 in
  let d1 = Symb.add_anon_symb db 0 in
  let d2 = Symb.add_anon_symb db 0 in
...
let test_noncomm_func_one_sort () =
  ...
  let db = prob.Prob.symbols in
  let p = Symb.add_anon_symb db 2 in
  let f = Symb.add_anon_symb db 3 in
  let q = Symb.add_anon_symb db 1 in
...
let test_noncomm_func_many_sorts_bounded_res_sort () =
  ...
  let db = prob.Prob.symbols in
  let p = Symb.add_anon_symb db 2 in
  let f = Symb.add_anon_symb db 4 in
  let q = Symb.add_anon_symb db 1 in
...
let test_noncomm_func_many_sorts_bounded_param_sorts2 () =
  let prob = Prob.create () in
  let db = prob.Prob.symbols in
  let p = Symb.add_anon_symb db 3 in
  let f = Symb.add_anon_symb db 2 in
  let q = Symb.add_anon_symb db 1 in
...
let test_noncomm_funcs_many_sorts () =
  ...
  let f = Symb.add_anon_symb db 2 in
  let q = Symb.add_anon_symb db 0 in
  let g = Symb.add_anon_symb db 1 in
...
let test_comm_funcs_many_sorts () =
  ...
  let f = Symb.add_anon_symb db 2 in
  let g = Symb.add_anon_symb db 2 in
  let q = Symb.add_anon_symb db 1 in
  Symb.set_commutative db f true;
